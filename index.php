             ...
             <li role="presentation" ><a href="images/01.jpg" class="text-center">Décoration</a></li>
						...
						<div class="row recherche well" style="margin-left: 0px; margin-right: 0px;">
                            ...
                            <form class="form-inline text-center" action="recherche.php" method="post">
                                ...
                                <div class="form-group">
                                    <input type="number" min="1" max="2000" class="form-control" name="reche_place" placeholder="Nombre de places" required>
                                </div>
                                <div class="form-group">
                ...
                <div class="col-xs-3">
                    <div class="thumbnail">
                      ...
                      $ins=$db->query('SELECT nom_salle,capacite_salle,prix_salle,photo_salle,lien_salle,type_salle FROM salle WHERE type_salle="Reception"');
                        ...
                        <div class="caption">
                        <?php
                          echo '<span>Salle de </span>'.$reponse['type_salle'].'<br>'.$reponse['nom_salle'].'<br>'.$reponse['capacite_salle'].' Places'.'<br>'
                            ?>
                            <p><a href="<?php echo $reponse['lien_salle'];?>" class="btn btn-primary" role="button">Voir plus</a>
										...
										$ins=$db->query('SELECT nom_salle,capacite_salle,prix_salle,photo_salle,lien_salle,type_salle FROM salle WHERE type_salle="Conference"');
											...
											<div class="caption">
												...
												echo '<span>Salle de </span>'.$reponse['type_salle'].'<br>'.$reponse['nom_salle'].'<br>'.$reponse['capacite_salle'].' Places'.'<br>'
													...
													<p><a href="<?php echo $reponse['lien_salle'];?>" class="btn btn-primary" role="button">Voir plus</a></p>
											</div>
									</div>
                </div>
                <div class="col-xs-3">
										...
										$ins=$db->query('SELECT nom_salle,capacite_salle,prix_salle,photo_salle,lien_salle,type_salle FROM salle WHERE type_salle="Conference"');
											...
											<div class="caption">
												...
												echo'<span>Salle de </span>'.$reponse['type_salle'].'<br>'.$reponse['nom_salle'].'<br>'.$reponse['capacite_salle'].' Places'.'<br>'
													...
													<p><a href="<?php echo $reponse['lien_salle'];?>" class="btn btn-primary" role="button">Voir plus</a></br>
                            <a href="delete.php?typ=<?= $reponse['type_salle']?>">Supprimer</a>
                          </p>
											</div>
									</div>
                </div>

        ...
        <div class="col-md-12">
         ...
         <div class="row">
            <ol class="breadcrumb" style="margin-left: 14px; margin-right: 14px">
              ...
              <li class="active">Salles de Reunion</li>
            </ol>    
        </div>
            <div class="row">
           <?php
            ...
            $req=$db->query('SELECT nom_salle,capacite_salle,prix_salle,photo_salle FROM salle WHERE type_salle = "Reunion"');
            ...
            while ($ans=$req->fetch())
            {
                ...
                <div class="col-xs-3"> 
                    <img src="<?php echo "images/réunion/".$ans['photo_salle'];?>" class="img-responsive" height="100" width="200"/>
                </div>
                        <div class="col-xs-3">
                        <?php echo $ans['nom_salle'].'<br>'.$ans['capacite_salle'].'<br>'.$ans['prix_salle'].'<br>';?>
                        </div>
                        <div class="col-xs-3">  
                        <a href="<?php echo $ans['lien_salle'];?>" class="btn btn-primary" role="button">Voir</a>
                         <a href="inscription.php" class="btn btn-danger" role="button" >Réserver</a>
                    </div>
                </div>
